...
base.com.getCurrentProject = function () {
    return window!=parent?parent.$.cookie('CurrentProject'):"";
};

base.com.formatSrcBillType = function (value) {
    var dict = {
        'receive': '收料单',
        'send': '发料单',
        'adjust':'库存调整',
...
base.com.bindCalcTotalMoney = function (self, fieldNum, fieldUnitPrice, fieldRowTotal, fieldAllTotal) {
...
base.com.calcTotalMoneyWhileRemoveRow = function (self, fieldRowTotal, fieldAllTotal) {
...
//弹出选择材料窗口
base.com.selectMaterial = function (vm, param) {
    var grid = vm.grid;
    ...
    var comapreArray = param._xml == "base.material_batches" ? ['MaterialCode', 'SrcBillType', 'SrcBillNo'] : ['MaterialCode'];
    ...
    opt.content = "<iframe id='frm_win_material' src='/base/home/lookupmaterial' style='height:100%;width:100%;border:0;' frameborder='0'></iframe>";  //frameborder="0" for ie7
