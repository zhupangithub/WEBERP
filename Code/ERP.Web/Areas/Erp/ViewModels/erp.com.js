...
erp.com.getCurrentProject = function () {
    return window!=parent?parent.$.cookie('CurrentProject'):"";
};

erp.com.formatSrcBillType = function (value) {
    var dict = {
        'receive': '收料单',
        'send': '发料单',
        'adjust':'库存调整',
...
erp.com.bindCalcTotalMoney = function (self, fieldNum, fieldUnitPrice, fieldRowTotal, fieldAllTotal) {
...
erp.com.calcTotalMoneyWhileRemoveRow = function (self, fieldRowTotal, fieldAllTotal) {
...
//弹出选择材料窗口
erp.com.selectMaterial = function (vm, param) {
    var grid = vm.grid;
    ...
    var comapreArray = param._xml == "erp.material_batches" ? ['MaterialCode', 'SrcBillType', 'SrcBillNo'] : ['MaterialCode'];
    ...
    opt.content = "<iframe id='frm_win_material' src='/erp/home/lookupmaterial' style='height:100%;width:100%;border:0;' frameborder='0'></iframe>";  //frameborder="0" for ie7
